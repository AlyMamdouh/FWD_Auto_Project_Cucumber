...
Feature: user should be able to login to the System
  ...
  Scenario: User login with valid User name and password
    ...
    When user enter Valid Data vaild Email is "fahd.tiger202@yahoo.com" , valid Password is "123456"
   ...
   # When  user enter "fahd.tiger202@gmail.com" and "123456"
    ...
    # actions inside login
      When user enter Invalid Login Data inavlid email is "fahd@yahoo.com" , invalid Password is "123456"
      And  user click on login button
    # Expected result
